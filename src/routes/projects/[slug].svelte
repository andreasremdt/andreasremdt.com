...
<main>
  ...
  <div class="max-w-6xl mx-auto px-4 pt-12 pb-24">
    ...
    <div
      class="prose mx-auto prose-a:no-underline focus:prose-a:outline-none focus:prose-a:text-emerald-500 prose-a:text-gray-900 prose-a:border-b-2 prose-a:border-emerald-400 hover:prose-a:text-emerald-500 prose-a:transition-colors"
    >
